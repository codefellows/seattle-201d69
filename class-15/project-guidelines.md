...
Day 0: Pitch the idea to your instructor. Once the idea is approved, create your repository, fill your project board with issues,begin scaffolding your files, and build out your requirements.

Day 1 - Monday: Deploy your site, then begin to build features.

Day 2 - Tuesday: This should be a big build-out day of features.
...
- 60 second introduction from each team member
